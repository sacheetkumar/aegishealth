...
export default function PrescriptionUpload({ onRecommendDoctors }: PrescriptionUploadProps) {
    ...
    const timer = setInterval(() => {
      setScanProgress(prev => {
        ...
        if (nextProgress >= 100) {
          ...
          // Generate realistic result based on filename keywords
  ...
  // Simulated OCR matching function
  const performMockOcr = (filename: string): ExtractionResult => {
    const name = filename.toLowerCase();

    // 1. Cardiac/Hypertension prescription
    ...
    // 3. Dermatological skin prescription
    ...
    // 4. Default case: Respiratory / Asthma prescription
    return {
  ...
  return (
    <div className={styles.container}>
      ...
      {/* Extracted Details Results Dashboard */}
      {!isAnalyzing && result && (
        <div className={styles.resultsContainer}>
          <div className={styles.resultCard}>
            ...
            <div className={styles.analysisGrid}>
              ...
              {/* Right Column: AI Condition referral summary */}
